...
public class TimeTest {
	...
	public Date getTimestampColoumn() {
		return timestampColoumn;
	}

	public void setTimestampColoumn(Date timestampColoumn) {
		this.timestampColoumn = timestampColoumn;
	}
