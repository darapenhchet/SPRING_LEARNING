...
import com.spring.config.annotation.WebController;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.spring.site", useDefaultFilters = false, includeFilters = @ComponentScan.Filter(WebController.class))
