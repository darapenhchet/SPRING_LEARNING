var Pleasure = {
	...
	settings: {
		...
		paths: {
			images: contextPath+"/resources/assets/globals/img",
			css: contextPath+"${pageContext.request.contextPath}/resources/assets/globals/css",
			plugins: contextPath+"${pageContext.request.contextPath}/resources/assets/globals/plugins"
		},
