 ...
 * Generated at: 2015-09-03 08:03:18 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t</md-button>\r\n");
      out.write("\t\t<h1>Spring Security-- HOME PAGE</h1>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t<md-list>\r\n");
      out.write("\t\t\t    \t<md-subheader class=\"md-no-sticky\"><h1>Articles</h1></md-subheader>\r\n");
      out.write("\t\t\t      \t<md-list-item class=\"md-3-line\" ng-repeat=\"article in articles\">\r\n");
      out.write("\t\t\t\t        <div class=\"md-list-item-text\">\r\n");
      out.write("\t\t\t\t          <h2>{{ article.id }}</h3>\r\n");
      out.write("\t\t\t\t          <h3>{{ article.title }}</h4>\r\n");
      out.write("\t\t\t\t          <p ng-bind-html=\"article.introtext\"></p>\r\n");
      out.write("\t\t\t\t          <p>{{ article.created }}</p>\r\n");
      out.write("\t\t\t\t        </div>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<script\r\n");
      out.write("\t\tsrc=\"https://ajax.googleapis.com/ajax/libs/angularjs/1.2.23/angular-sanitize.min.js\"></script>\r\n");
      out.write("\t\t\r\n");
      out.write("\t<script\r\n");
      out.write("\t\tsrc=\"https://ajax.googleapis.com/ajax/libs/angular_material/0.9.4/angular-material.min.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t\tvar app = angular.module('StarterApp', [ 'ngMaterial', 'ngSanitize']);\r\n");
      out.write("\t\t\r\n");
      out.write("/* \t\tapp.config(function($mdIconProvider) {\r\n");
      out.write("\t\t\t$mdIconProvider\r\n");
      out.write("\t\t\t\t.iconSet('communication', 'img/icons/sets/communication-icons.svg', 24);\r\n");
      out.write("\t\t}) \r\n");
      out.write("*/\r\n");
      out.write("\r\n");
      out.write("\t\tapp.controller('AppCtrl', [ '$scope', '$http', '$mdSidenav',\r\n");
      out.write("\t\t\tfunction($scope, $http, $mdSidenav) {\r\n");
      out.write("\t\t\t\t$scope.toggleSidenav = function(menuId) {\r\n");
      out.write("\t\t\t\t\t$mdSidenav(menuId).toggle();\r\n");
      out.write("\t\t\t\t};\r\n");
      out.write("\t\t\t\t$http.get(\"https://schedule-darapenhchet-1.c9.io/index.php/article\")\r\n");
      out.write("\t\t\t\t\t.success(function(response){\r\n");
      out.write("\t\t\t\t\t\t$scope.articles = response.RESP_DATA.ARTICLES;\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t]);\r\n");
